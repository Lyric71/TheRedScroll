...
Every figure used in a published article, with the citation that goes with it.
...
from appearing three different ways across fifty-two articles.

**Append to this file before you finish a draft.** A figure used and not logged
will be researched again next week.
...
1. **A source with no date does not go in this file.** Find the date or drop
   the figure.
1. **A source with one check does not go in this file.** Every entry carries
   two verification dates. Research in Chinese first; English sources confirm.
2. **Never log a competitor blog as the source for a platform fact.** Go to the
   platform's own documentation, a regulator, or a dated trade publication. If
   a competitor cites a real source, log their source, not them.
3. **Our own data is logged separately**, in the section below, with sample
   size and period. It is cited as ours, never presented as market data.
4. **Recheck anything older than 12 months** before reusing it. Move stale
...
<!-- Seed this section before the first run with any figures you already
trust. Suggested starting set, all needed in weeks 1 to 5:

- WeChat monthly active users
- WeChat Official Account verification fee, annual
- WeChat ad account minimum deposit
- WeChat Moments ad daily minimum spend
- Xiaohongshu monthly active users
- Xiaohongshu Blue V annual verification fee
- Xiaohongshu ad account minimum deposit
- Xiaohongshu share of traffic arriving through search
- Douyin daily active users
- Douyin ad account minimum deposit
...
- As of: May 2026 (article dated 2026-05-27)
- Source: Xiaohongshu (小红书) Video Creator Trend Observation Report, reported by Beijing Business Today (北京商报) via Sina Finance (新浪财经)
...
- As of: May 2025 (article dated 2025-11-19)
- Source: QuestMobile, reported by The Paper (澎湃新闻)
- URL: https://m.thepaper.cn/newsDetail_forward_31995524
- Verified 1: 2026-09-07, fetched, "2025年5月，小红书国内月活跃用户2.42亿，同比增长13.2%" confirmed
- Verified 2: 2026-09-07, re-fetched, unchanged
- Used in: xiaohongshu-marketing-foreign-brands
- Notes: Same figure also on Sohu, 2025-07-15 (https://www.sohu.com/a/914185363_122045489). Panel-based mainland count; lower than the platform's own number by design.

### Xiaohongshu official advertiser brief: audience profile
- Value: 300 million MAU; male to female 3:7; monthly search penetration 70%; post-95 50%; post-00 35%; tier 1 and 2 cities 50%; over 100 million content sharers
- As of: April 2025 (page dated 2025-04-24)
- Source: Xiaohongshu official brief (小红书官方通案), reported by Qian-gua Data (千瓜数据)
...
- As of: January to November 2025 (Xiaohongshu data center); conference 2025-12-22; article 2025-12-24
- Source: Xiaohongshu (小红书) 2026 WILL conference, reported by 100EC (网经社)
...
- As of: December 2024 (article dated 2024-12-13)
- Source: Zhou Tian Finance (周天财经), reported by 199IT
...
- Value: open to mainland, overseas and Hong Kong, Macau and Taiwan companies; 600 yuan per application; one year; annual review; each order valid 30 days; overseas entities, annual reviews and renames on the PC site only; non-Chinese, non-English documents need a translation stamped by a translation company
- As of: page undated; confirmed September 2026 (platform documentation)
- Source: Xiaohongshu (小红书) enterprise account verification guide (platform PDF)
...
- Value: 10% of the deal in standard mode; 20% in the premium mode that adds platform promotion
- As of: October 2022 (article dated 2022-10-27)
- Source: Niaoge Biji (鸟哥笔记)
...
- As of: page undated; confirmed September 2026 (platform documentation)
- Source: Tencent customer service (腾讯客服), 境外主体账号认证问题汇总
- URL: https://kf.qq.com/faq/190723aQvMR31907233IF7FV.html
...
- As of: page undated; confirmed September 2026 (platform documentation)
- Source: Tencent customer service (腾讯客服), 境外主体账号认证所需资料
...
- As of: page undated; confirmed September 2026 (platform documentation)
- Source: Tencent customer service (腾讯客服), 境外主体服务号注册流程
...
- As of: page undated; confirmed September 2026 (platform documentation)
- Source: Tencent customer service (腾讯客服), 公众平台注册信息登记的审核时间是多久
...
- Source: Ocean Engine (巨量引擎), 抖音蓝V怎么认证呢
...
- Value: qualitative. The platform's FAQ describes the enterprise account as "面向中国地区企业可以申请认证的账号"
- As of: May 2022 (page dated 2022-05-12)
- Source: Ocean Engine (巨量引擎), 快速了解：什么是抖音企业号
...
- NMPA cosmetics filing requirement for imported products
- China Advertising Law provisions on superlative claims
- Blue Hat health food registration requirement and timeline
- Imported food labelling requirement
- Trademark registration timeline and fee, CNIPA
- ICP filing requirement
- Cross-border e-commerce positive list treatment
-->

### Trademark average examination period, CNIPA
- Value: average trademark examination period held steady at 4 months (invention patents 15 months)
- As of: January 2026 (page dated 2026-01-07; figures for 2025)
- Source: China National Intellectual Property Administration (国家知识产权局), 2026年全国知识产权局局长会议工作报告（摘编）
- URL: https://www.cnipa.gov.cn/art/2026/1/7/art_53_203564.html
- Verified 1: 2026-09-08, fetched, "商标注册平均审查周期稳定在4个月" and date confirmed
...
- China KOC and KOL fee bands by tier
- China influencer market size
- China beauty market size or growth
- Chinese outbound travel volume
- China EV share of new car sales
- China share of global luxury spend
- Baidu search share
...
size and period stated in the article itself. It is never presented as market
data.
...
### TheRedScroll launch timeline, as published
- Value: 30-minute discovery call, fixed-price proposal, live in two weeks; "Fourteen days from signed contract to first post going live"
- Sample: n/a (process statement, not measured data)
...
<!-- Move entries here when they go stale rather than deleting them, with the
date retired and what replaced them. Published articles still cite these. -->
