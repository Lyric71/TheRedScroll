...
| Field | Value |
|---|---|
| Working H1 | Viessmann and iGuzzini: how two B2B brands built China social from zero |
...
2. Viessmann: the technical authority play
3. iGuzzini: the specifier and architect play
4. What content a B2B audience in China actually reads
5. WeChat as a lead engine, not a magazine
6. The WeCom handoff: where social becomes pipeline
7. How long it took to see a qualified lead
...
- Client outcomes from our own engagements, cleared before publishing
- One external dated source on B2B buyer behavior in China
...
- Lead flow diagram: content to WeCom to sales
- Feature image: an industrial detail shot, machined metal or a lighting fixture, close crop
...
| Meta description | 152 chars | A teardown of two B2B China social programs: the technical authority play, the specifier play, the WeCom handoff and how long the first lead took. (146 chars) |
