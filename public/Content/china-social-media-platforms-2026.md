<!--
SEO Title: China Social Media Platforms: 2026 Brand Guide
Meta Description: A 2026 guide to China's social media platforms for foreign brands. Real user numbers, commerce features, and where to start. From the ground.
Excerpt: WeChat, Douyin, RedNote, Weibo, and a dozen more Chinese platforms. A clear, current guide for foreign brands deciding where to build in China in 2026.
-->

# China's Social Media Platforms: A Guide for Foreign Brands in 2026

<!-- IMAGE
slug: hero-china-platforms
placement: full-width
alt: Illustration of China's main social media platforms as a connected network
prompt: Wide editorial hero illustration. A stylized map silhouette of China rendered in Rice Paper tone, with abstract app-style rounded tiles floating above it connected by thin Ink lines, suggesting a network of platforms. One central tile and a few connecting lines picked out in Vermillion as the only color accent. Calm, premium, editorial. No text, no real logos. Style: TheRedScroll brand system. Palette only: White #FFFFFF, Rice Paper #F7F2EE, Ink #1A1A1A, Vermillion #CC3333 (used sparingly as accent only), Stone #5C5C5C, Warm Gray #E8E0D8. Flat editorial illustration, clean vector, no gradients, no drop shadows, generous white space. No real logos, no brand marks, no celebrity faces, no text baked into the image unless specified. 16:9 unless noted. Aspect ratio 21:9, hero banner.
-->
...
<!-- IMAGE
slug: closed-loop-diagram
placement: inline-right
alt: Diagram of the closed-loop model: discovery to content to checkout inside one app
prompt: Clean horizontal flow diagram showing three connected stages inside a single rounded phone-screen frame: 'Discover', 'Watch', 'Buy', joined by arrows that curve back into a loop. Ink linework on Rice Paper background, the looping return arrow highlighted in Vermillion. Minimal, infographic style, labels in a clean sans-serif. Style: TheRedScroll brand system. Palette only: White #FFFFFF, Rice Paper #F7F2EE, Ink #1A1A1A, Vermillion #CC3333 (used sparingly as accent only), Stone #5C5C5C, Warm Gray #E8E0D8. Flat editorial illustration, clean vector, no gradients, no drop shadows, generous white space. No real logos, no brand marks, no celebrity faces, no text baked into the image unless specified. 16:9 unless noted.
-->
...
<!-- IMAGE
slug: wechat-superapp
placement: full-width
alt: Illustration of WeChat as a super-app holding many everyday functions
prompt: Editorial illustration of a single large rounded app tile in Ink, opening to reveal small icon modules inside it: a chat bubble, a wallet, a QR code, a shopping bag, a mini-program grid, a video play button. Conveys 'everything in one app'. One module (the wallet or QR) accented in Vermillion. Flat vector on White. No real WeChat logo or branding. Style: TheRedScroll brand system. Palette only: White #FFFFFF, Rice Paper #F7F2EE, Ink #1A1A1A, Vermillion #CC3333 (used sparingly as accent only), Stone #5C5C5C, Warm Gray #E8E0D8. Flat editorial illustration, clean vector, no gradients, no drop shadows, generous white space. No real logos, no brand marks, no celebrity faces, no text baked into the image unless specified. 16:9 unless noted.
-->
...
<!-- IMAGE
slug: douyin-shoppable-video
placement: inline-left
alt: Illustration of a short-form video with an in-feed shopping link
prompt: Vertical phone frame showing a stylized short-form video scene with a small product card and a 'buy' tag overlaid in the lower corner, plus a play triangle. Suggests watching turning instantly into buying. Ink and Stone linework on Rice Paper, the buy tag in Vermillion. Flat editorial vector. No real logos or faces. Style: TheRedScroll brand system. Palette only: White #FFFFFF, Rice Paper #F7F2EE, Ink #1A1A1A, Vermillion #CC3333 (used sparingly as accent only), Stone #5C5C5C, Warm Gray #E8E0D8. Flat editorial illustration, clean vector, no gradients, no drop shadows, generous white space. No real logos, no brand marks, no celebrity faces, no text baked into the image unless specified. 16:9 unless noted.
-->
...
<!-- IMAGE
slug: rednote-notes-grid
placement: full-width
alt: Illustration of a RedNote-style grid of lifestyle review notes
prompt: A clean staggered grid of rounded 'note' cards, each showing a simple abstract lifestyle scene (a skincare bottle, a travel landmark, a plate of food, a home interior) with tiny heart and bookmark icons. Conveys peer reviews and product discovery. Warm Gray and Rice Paper cards on White, one heart icon in Vermillion. Flat editorial vector, no text, no real logos. Style: TheRedScroll brand system. Palette only: White #FFFFFF, Rice Paper #F7F2EE, Ink #1A1A1A, Vermillion #CC3333 (used sparingly as accent only), Stone #5C5C5C, Warm Gray #E8E0D8. Flat editorial illustration, clean vector, no gradients, no drop shadows, generous white space. No real logos, no brand marks, no celebrity faces, no text baked into the image unless specified. 16:9 unless noted.
-->
...
<!-- IMAGE
slug: weibo-trending-square
placement: inline-right
alt: Illustration of Weibo as a public square of trending topics
prompt: Editorial illustration of an open public-square motif: many small speech bubbles and hashtag shapes rising upward from a crowd of simple abstract figures, a few bubbles connected to a 'trending' flame or arrow shape. Conveys public conversation and virality. Ink figures and Stone bubbles on Rice Paper, one trending marker in Vermillion. Flat vector. No text, no real logos. Style: TheRedScroll brand system. Palette only: White #FFFFFF, Rice Paper #F7F2EE, Ink #1A1A1A, Vermillion #CC3333 (used sparingly as accent only), Stone #5C5C5C, Warm Gray #E8E0D8. Flat editorial illustration, clean vector, no gradients, no drop shadows, generous white space. No real logos, no brand marks, no celebrity faces, no text baked into the image unless specified. 16:9 unless noted.
-->
...
<!-- IMAGE
slug: secondary-platforms-icons
placement: full-width
alt: Illustration of secondary China platforms: Bilibili, Kuaishou, Zhihu, Toutiao
prompt: A tidy row of four distinct abstract app tiles representing, in order, a video/community platform (play button with bullet-comment streaks), a grassroots short-video platform (a simple hand or village motif), a Q&A knowledge platform (a question mark in a speech bubble), and a news feed (stacked article lines). Each tile in Ink and Stone on Rice Paper, one accent detail per tile in Vermillion. Flat editorial vector, evenly spaced, no text labels, no real logos. Style: TheRedScroll brand system. Palette only: White #FFFFFF, Rice Paper #F7F2EE, Ink #1A1A1A, Vermillion #CC3333 (used sparingly as accent only), Stone #5C5C5C, Warm Gray #E8E0D8. Flat editorial illustration, clean vector, no gradients, no drop shadows, generous white space. No real logos, no brand marks, no celebrity faces, no text baked into the image unless specified. 16:9 unless noted.
-->
...
<!-- IMAGE
slug: china-entry-checklist
placement: inline-left
alt: Illustration of the setup hurdles for foreign brands: verification, localization, compliance
prompt: Editorial illustration of a checklist or document with three rows: a verification badge/ID icon, a translation/localization icon (two speech bubbles with different scripts, abstract not real text), and a compliance shield icon. A stamp or check mark on the document in Vermillion. Ink and Stone linework on Rice Paper. Flat vector, calm and official-feeling, no real logos. Style: TheRedScroll brand system. Palette only: White #FFFFFF, Rice Paper #F7F2EE, Ink #1A1A1A, Vermillion #CC3333 (used sparingly as accent only), Stone #5C5C5C, Warm Gray #E8E0D8. Flat editorial illustration, clean vector, no gradients, no drop shadows, generous white space. No real logos, no brand marks, no celebrity faces, no text baked into the image unless specified. 16:9 unless noted.
-->
...
<!-- IMAGE
slug: ai-produces-humans-decide
placement: full-width
alt: Illustration contrasting AI content production with human strategic decisions
prompt: Split editorial illustration. Left side: a machine or gear motif rapidly outputting a stack of content cards (speed, volume). Right side: a single human figure thoughtfully selecting one card and marking it. A clear divide between the two halves. Ink and Stone on Rice Paper, the human's chosen card accented in Vermillion. Flat vector, no text, no faces in detail. Style: TheRedScroll brand system. Palette only: White #FFFFFF, Rice Paper #F7F2EE, Ink #1A1A1A, Vermillion #CC3333 (used sparingly as accent only), Stone #5C5C5C, Warm Gray #E8E0D8. Flat editorial illustration, clean vector, no gradients, no drop shadows, generous white space. No real logos, no brand marks, no celebrity faces, no text baked into the image unless specified. 16:9 unless noted.
-->
...
<!-- IMAGE
slug: starting-platform-mix
placement: inline-right
alt: Illustration of a recommended starting platform mix for foreign brands
prompt: Simple three-tile arrangement showing a base tile labeled-by-icon as a 'home base' (a building or anchor motif), connected to a 'discovery' tile (a magnifying glass over a note card) and a 'reach and sales' tile (an upward arrow over a shopping bag). Arranged as a small starter map with thin Ink connector lines. Rice Paper tiles on White, the base tile accent in Vermillion. Flat editorial vector, no real logos. Style: TheRedScroll brand system. Palette only: White #FFFFFF, Rice Paper #F7F2EE, Ink #1A1A1A, Vermillion #CC3333 (used sparingly as accent only), Stone #5C5C5C, Warm Gray #E8E0D8. Flat editorial illustration, clean vector, no gradients, no drop shadows, generous white space. No real logos, no brand marks, no celebrity faces, no text baked into the image unless specified. 16:9 unless noted.
-->
