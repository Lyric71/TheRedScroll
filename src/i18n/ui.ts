...
export const ui = {
  ...
  zh: {
    ...
    'nav.bookCall': '预约通话',
    'nav.viewAll': '查看全部',
    'nav.viewAll.services': '全部服务',
    'nav.viewAll.platforms': '全部平台',
    'nav.viewAll.about': '走进 TheRedScroll',

    // Service names & subtitles
    'nav.services.strategy': '策略、活动与数据',
    'nav.services.strategy.sub': '市场调研、内容排期、月度复盘',
    'nav.services.advertising': '广告投放',
    'nav.services.advertising.sub': '媒介策略与买量执行',
    'nav.services.content': '内容制作',
    'nav.services.content.sub': 'AI 视觉、视频、本土文案',
    'nav.services.influencer': '达人营销',
    'nav.services.influencer.sub': 'KOL 与 KOC 合作',
    'nav.services.marketEntry': '进入中国市场',
    'nav.services.marketEntry.sub': '公司注册、账号开通、本土落地',
    'nav.services.crm': 'CRM 与私域',
    ...
    'nav.platforms.douyin.sub': '短视频与直播带货',
    'nav.platforms.weibo': '微博',
    'nav.platforms.weibo.sub': '大众曝光、公关、热搜话题',
    'nav.platforms.others': '更多平台',
    'nav.platforms.others.sub': 'B站、快手、知乎 等 14 个平台',

    // About sub-nav
    'nav.about.team': '我们的团队',
    'nav.about.team.sub': '常驻上海与香港',
    'nav.about.ai': '我们的 AI',
    'nav.about.ai.sub': 'AI 如何贯穿每一项服务',

    // Footer
    'footer.tagline': '中国社媒，我们帮你把品牌做大。粉丝、互动、转化，一起涨。范围透明，一口价，没有后续账单。',
    'footer.services': '服务',
    'footer.discover': '探索',
    'footer.connect': '联系我们',
    'footer.group': '所属集团',
    ...
    'footer.crmPrivateDomain': 'CRM 与私域',
